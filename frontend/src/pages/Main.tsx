...
import CallbackWidget from "@/widgets/callback"

import MainImg from "/imgs/main2.jpg"
import CallbcakImg from "/imgs/callback.jpg";
...
function Main(){
    return(
        <div className="flex flex-col gap-24 my-12">
            ...
            <QuoteWidget name="Почему мы?" text="У нас есть то, чего нет у других...">
            ...
            <CallbackWidget img={CallbcakImg}/>
